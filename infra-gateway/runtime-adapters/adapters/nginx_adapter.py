...
class NginxAdapter(ProxyAdapter):
    ...
    def generate(self, base_dir: str, output_dir: str) -> None:
        ...
        with open(nginx_conf_path, "w") as f:
            ...
            f.write("    # Speed Optimization: Payload Compression (Gzip)\n")
            f.write("    gzip on;\n")
            f.write("    gzip_types text/plain text/css application/json application/javascript text/xml application/xml;\n")
